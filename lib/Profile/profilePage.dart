            ...
            child: Column(
              ...
              children: [
                ...
                ListTile(
                  ...
                  title: Text("Terms & Conditions",style: TextStyle(color: Colors.black,fontFamily: 'description', fontSize: 15),),
                ),
                ListTile(
                  leading: Icon(Icons.policy_outlined),
                  title: Text("Privacy Policy",style: TextStyle(color: Colors.black,fontFamily: 'description', fontSize: 15),),
                ),
                ListTile(
